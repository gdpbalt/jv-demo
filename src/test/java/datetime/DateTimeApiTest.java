...
public class DateTimeApiTest {
  ...
  public void getDate_Ok() {
    ...
    Assert.assertEquals(
        "getData with params: " + Arrays.toString(dateParams) + "\nmust be: " + expected + "\n",
        expected,
        result);
    ...
    Assert.assertEquals(
        "getData with params: "
            + Arrays.toString(secondDateParams)
            + "\nmust be: "
            + expected
            + "\n",
        expected,
  ...
  public void addHours_Ok() {
    ...
    Assert.assertEquals(
        "Result of addHours with time "
            + LOCAL_DATE_TIME.toLocalTime()
            + " and hoursToAdd 268 must be "
            + expected
            + "\n",
        expected,
        result);
  ...
  public void addMinutes_Ok() {
    ...
    Assert.assertEquals(
        "Result of addMinutes with time "
            + LOCAL_DATE_TIME.toLocalTime()
            + " and minutesToAdd 589 must be "
            + expected
            + "\n",
        expected,
        result);
  ...
  public void addSeconds_Ok() {
    ...
    Assert.assertEquals(
        "Result of addSeconds with time "
            + LOCAL_DATE_TIME.toLocalTime()
            + " and secondsToAdd 369589 must be "
            + expected
            + "\n",
        expected,
        result);
    ...
    Assert.assertEquals(
        "Result of addSeconds with time "
            + LOCAL_DATE_TIME.toLocalTime()
            + " and secondsToAdd 234555 must be "
            + expected
            + "\n",
        expected,
        result);
  ...
  public void addWeeks_Ok() {
    ...
    Assert.assertEquals(
        "Result of addWeeks with date "
            + LOCAL_DATE_TIME.toLocalDate()
            + " and weeksToAdd 2 must be "
            + expected
            + "\n",
        expected,
        result);
  ...
  public void getDateInSpecificTimeZone_Ok() {
    ...
    LocalDateTime actualResult1 =
        dateTimeApi.getDateInSpecificTimeZone("2020-04-16T15:23:01Z", "Asia/Tokyo");
    Assert.assertEquals(
        "DateTime 2020-04-16T15:23:01Z in timezone Asia/Tokyo must be " + expectedResult1 + "\n",
        expectedResult1,
        actualResult1);

    LocalDateTime expectedResult2 = LocalDateTime.parse("2020-04-16T18:23:01");
    LocalDateTime actualResult2 =
        dateTimeApi.getDateInSpecificTimeZone("2020-04-16T15:23:01Z", "Europe/Athens");
    Assert.assertEquals(
        "DateTime 2020-04-16T15:23:01Z in timezone Europe/Athens must be " + expectedResult2 + "\n",
        expectedResult2,
        actualResult2);
  }
  ...
  public void offsetDateTime_UkraineOk() {
    LocalDateTime localDateTime = LocalDateTime.of(2019, Month.SEPTEMBER, 6, 13, 17);
    ...
    Assert.assertEquals(
        "LocalDateTime " + localDateTime + " in Ukrainian timezone must be " + expected + "\n",
        expected,
        result);
  ...
  public void parseDate_Ok() {
    ...
    Assert.assertEquals(
        "Method parseDate must return " + expected + " for input 20190921\n", expected, result);
    expected = LocalDate.of(2020, 3, 17);
    result = dateTimeApi.parseDate("20200317");
    Assert.assertEquals(
        "Method parseDate must return " + expected + " for input 20200317\n", expected, result);
  }
  ...
  public void customParseDate_Ok() {
    ...
    Assert.assertEquals(
        "Method customParseDate must return " + expected + " for input 06 Sep 2019\n",
        expected,
        result);
    expected = LocalDate.of(2021, 6, 9);
    result = dateTimeApi.customParseDate("09 Jun 2021");
    Assert.assertEquals(
        "Method customParseDate must return " + expected + " for input 09 Jun 2021\n",
        expected,
        result);
  }
  ...
  public void formatDate_Ok() {
    ...
    Assert.assertEquals(
        "LocalDateTime must be formatted as: " + expected + "\nbut was: " + result + "\n",
        expected,
        result);
